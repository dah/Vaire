...
#[derive(Clone)]
pub(super) struct MemoryPreferences(pub(super) Arc<Mutex<PreferencesV2>>);
...
pub(super) fn openrouter_preferences(model_id: &str) -> PreferencesV2 {
